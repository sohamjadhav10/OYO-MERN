    ...
    return(
        <div className="na1">
            <div className="navbar navbar-expand-lg n1" >
                ...
                <div className="collapse navbar-collapse nb" id="navbarNav">
                    <div className="nav1 nav11" >
                    <div><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-wikipedia" viewBox="0 0 16 16">
                    ...
                    <div>
                        <h6>OYO for Business</h6>
                    </div>
                    </div>
                    <div className="nav3 nav33">
                    <div>
                    ...
                    <div className="nav5 nav55" >
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-globe" viewBox="0 0 16 16">
                    ...
                    <div>
                        <h6><a className="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">English</a>
                        </h6>
                    </div>
                    </div>
